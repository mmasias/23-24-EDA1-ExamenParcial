class Monitor {
    ...
    public void mostrarListaNiños() {
        System.out.print(" >  " + this.nombre + " tiene en cola a: " + colaNiños.numeroNiños() + " niños: ");
    ...
    public void entregaNiños(Monitor otroMonitor) {
        if (colaNiños.hayNiños()) {
            System.out.println(" >  " + this.nombre + " le manda a " + otroMonitor.nombre + " un niño");
            Niño unNiño = colaNiños.removeNiño();
            colaNiños.addNiño(unNiño);
    ...
    public boolean tieneNiñosEnCola() {
        return !colaNiños.isEmpty();
    }

    public int cantidadNiñosEnCola() {
